package ui.dialog {
	...
	public class PromptDialog extends Dialog{
		...
		public function PromptDialog(message:String = "", funcYes:Function = null, funcNo:Function = null, wait:Boolean = true):void{
			super(wait);
			//--------------------------------------------------------------------------------
			mc = new swcPromptDialog();  //common.swc 용
			addChild(mc);
			//--------------------------------------------------------------------------------
		...
		private function refresh():void{
			...
			mc.textField.y		= Math.round(mc.base.height / -2 + paddingTop + (mc.base.height - paddingTop - mc.textField.height - paddingBottom) / 2 - 20);
			
			mc.inputField.width = mc.base.width - 40;
			mc.inputField.x 	=mc.inputField.width / -2;
			mc.inputField.y 	= Math.round(mc.base.height / 2 - 100);
